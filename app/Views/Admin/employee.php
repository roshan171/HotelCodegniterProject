                ...
                <div class="container-fluid">
                  ...
                  <a href="<?php echo base_url('/create-employee');?>" class="btn btn-primary m-3"> Add Employee</a>
                                   ...
                                   <th scope="col">Email</th>
                                    ...
                                    <td><?php echo $row['phone'];?></td>
                                     ...
                                     <td><?php echo $row['joining_date'];?></td>
                                                  ...
                                                  <td>
    <a href="<?php echo base_url('edit-employee/'.$row['id']);?>" class="btn btn-primary"> Edit</a>

    <a href="<?php echo base_url('delete-employee/'.$row['id']);?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this product?')"> Delete</a>
  </td>
