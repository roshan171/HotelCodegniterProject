                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <!-- <a href="" class="btn btn-primary m-4">Add Employee</a> -->
                                   ...
                                   <th scope="col">Email</th>
                                    ...
                                    <td><?php echo $row['phone'];?></td>
                                      ...
                                      <td><?php echo $row['person'];?></td>
                                                  ...
                                                  <td>
    <a href="<?php echo base_url('edit-reserve/'.$row['id']);?>" class="btn btn-primary"> Edit</a>

    <a href="<?php echo base_url('delete-reserve/'.$row['id']);?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this product?')"> Delete</a>
  </td>
