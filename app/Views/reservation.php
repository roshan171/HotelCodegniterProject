...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
                    ...
                    <li class="nav-item "><a class="nav-link" href="<?php echo base_url('user')?>">Home</a></li>
                        ...
                        <li class="nav-item active"><a class="nav-link" href="<?php echo base_url('reservation')?>">Reservation</a></li>
	...
	<div class="reservation-box">
		<div class="container">
			...
			<form action="<?php echo base_url('add-reservation')?>" method="post">
  <div class="form-row">
  ...
  <div class="form-group col-md-6">
    ...
    <input id="input_time" class="time form-control picker__input" required  name="time" placeholder="Select Time">
  </div>
  <div class="form-group col-md-6">
    <label for="inputAddress2">Email:</label>
    <input type="text" class="form-control" id="inputAddress2" name="email" placeholder=" Enter Your Email" required>
  </div></div>
  <div class="form-row">
   
    <div class="form-group col-md-6">
      <label for="inputState">State:</label>
      <select id="inputState" class="form-control" name="person">
	...
	<div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" id="inputCity" placeholder="Enter Your Phone" name="phone" required>
    </div>
  
  </div>
<div class="text-center">
  <button type="submit" class="btn btn-common" name="submit">Book Now</button>
  </div>
</form>
